<x-app-layout>
    ...
    <div class="mx-auto max-w-5xl space-y-6 px-6">
        ...
        <section class="grid items-start gap-6 md:grid-cols-2">
            @can('approveQuoteReview', $orden)
                <div class="rounded-xl border border-green-700 bg-green-950 p-6">
                    ...
                    <form action="{{ route('operacion.cotizaciones.aprobar', ['orden' => $orden->id]) }}" method="POST" class="mt-5 space-y-4">
            ...
            @can('rejectQuoteReview', $orden)
                <div class="rounded-xl border border-red-700 bg-red-950 p-6">
                    ...
                    <p class="mt-2 text-sm text-red-100">
                        Indica claramente qué información debe corregirse.
                    </p>

                <form action="{{ route('operacion.cotizaciones.rechazar', ['orden' => $orden->id]) }}" method="POST" class="mt-5 space-y-4">
                        @csrf
